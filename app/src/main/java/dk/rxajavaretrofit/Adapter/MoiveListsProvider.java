 ...
 * @ 主界面布局
 */
public class MoiveListsProvider
        extends ItemViewProvider<Movie , MoiveListsProvider.BookListHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull final BookListHolder holder, @NonNull final Movie bookInfo) {
...
//        holder.tv_book_info.setText(bookInfo.getInfoString());
        holder.tv_book_description.setText("\u3000" + bookInfo.getOriginal_title());
